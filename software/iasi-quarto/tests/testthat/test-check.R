...
test_that("check accepts the canonical singular release path", {
  root = .copy_test_fixture(
    "check",
    "regular-without-index"
  )
...
test_that("check rejects the obsolete plural releases path", {
  root = .copy_test_fixture(
    "check",
    "regular-without-index"
  )
...
test_that("check requires paths.release to be a non-empty string", {
  root = .copy_test_fixture(
    "check",
    "regular-without-index"
  )
